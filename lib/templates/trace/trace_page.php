<!-- <?php echo strtoupper(System::getInstance()->request_method); ?> <?php if (System::getInstance()->ajax): ?>XHR<?php endif; ?>: <?php echo System::getInstance()->query; ?> -->
<h3><span class="label label-default"><?= strtoupper(System::getInstance()->request_method) ?></span><?php if (System::getInstance()->ajax): ?> <span
        class="label label-warning">XHR</span><?php endif; ?> <?= System::getInstance()->paths['current_full'] ?></h3>
<div role="tabpanel">
    <ul id="nav_menu" class="col-md-2 nav nav-pills nav-stacked" role="tablist">
        <li class="active">
            <a href="#div_statistics" data-toggle="tab" aria-controls="div_statistics"><span
                    class="glyphicon glyphicon-stats" aria-hidden="true"></span> Statistics</a>
        </li>
        <li>
            <a href="#div_request" data-toggle="tab" aria-controls="div_page"><span class="glyphicon glyphicon-transfer"
                                                                                    aria-hidden="true"></span>
                Request</a>
        </li>
        <li>
            <a href="#div_page" data-toggle="tab" aria-controls="div_page"><span class="glyphicon glyphicon-th-list"
                                                                                 aria-hidden="true"></span> Page
                {$p}</a>
        </li>
        <li>
            <a href="#div_browser" data-toggle="tab" aria-controls="div_browser"><span class="glyphicon glyphicon-globe"
                                                                                       aria-hidden="true"></span>
                Browser {$p.browser}</a>
        </li>
        <li>
            <a href="#div_session" data-toggle="tab" aria-controls="div_session"><span
                    class="glyphicon glyphicon-th-list" aria-hidden="true"></span> Session {$p.session}</a>
        </li>
        <li>
            <a href="#div_paths" data-toggle="tab" aria-controls="div_paths"><span class="glyphicon glyphicon-th-list"
                                                                                   aria-hidden="true"></span> Paths
                {$p.paths}</a>
        </li>
        <li>
            <a href="#div_template" data-toggle="tab" aria-controls="div_template"><span
                    class="glyphicon glyphicon-th-list" aria-hidden="true"></span> Template Vars</a>
        </li>
        <li>
            <a href="#div_db" data-toggle="tab" aria-controls="div_db"><span class="glyphicon glyphicon-hdd"
                                                                             aria-hidden="true"></span> Database</a>
        </li>
        <?php if (System::getInstance()->logged) { ?>
            <li>
                <a href="#div_user" data-toggle="tab" aria-controls="div_user"><span class="glyphicon glyphicon-user"
                                                                                     aria-hidden="true"></span> Logged
                    User {$p.user}</a>
            </li>
        <?php } ?>
    </ul>
    <div class="col-md-10 tab-content">
        <div role="tabpanel" id="div_statistics" class="tab-pane panel panel-default active">
            <div class="panel-body">
                ...
                <table class="table table-condensed">
                    ...
                    <?php if (System::getInstance()->db_conn) { ?>
                        <tr>
                            <td>DB queries:</td>
                            <td><strong><?= System::getInstance()->db_conn->total_execution_time() ?> s</strong></td>
                        </tr>
                    <?php } ?>
                </table>
        ...
        <div role="tabpanel" id="div_request" class="tab-pane panel panel-default">
            <div class="panel-body">
                <?php if (!System::getInstance()->ispostback) { ?>
                    <h4>$_GET</h4>
                    <?= self::get_debug($_GET) ?>
                <?php } else { ?>
                    <h4>$_POST</h4>
