...
{
    /**
     * Check required. rule='required|5' - required length 5
     * @return bool
     * @param mixed $value - key of the field
    ...
    /**
     * Check rangelength string length 'rangelength|2|5'
     * @return int
     * @param mixed $value
     * @param mixed $params [optional]
     */
    ...
    /**
     * Check it contains only alpabetic chars
     * @return int
     * @param object $value
     */
...
class FormField
{
    ...
    private $field_name = '';
    /**
     * @var FormRule[] $rules Rules to apply to field
     */
    private $rules = array();
    /**
     * @var FormFilter[] $filters Filters to apply to field
     */
...
class FormObject
{
    ...
    private $_hash = '';
    /**
     * @var FormField[] $fields Fields in form data array
     */
...
{
    /**
     * @var FormObject[] $forms Forms data array
     */
    private $forms = array();
