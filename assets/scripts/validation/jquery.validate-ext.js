...
}, $.validator.format("Please enter a valid username between 6-64 characters long, no uppercase letters and starting with a letter."));
...
}, $.validator.format("Please enter a valid percent between 0 and 100."));
...
}, $.validator.format("Please enter a valid username between 2-64 characters long, starting with uppercase letter."));
...
jQuery.validator.addMethod("dateinterval", function(value, element, params) {
	return 1;
}, $.validator.format("The dates interval is not valid."));
...
}, $.validator.format("Please use letters only (a-z) in this field."));
...
}, $.validator.format("Already in database!"));
...
}, $.validator.format("Not found in database!"));
...
}, $.validator.format("Security code is wrong!"));
...
}, $.validator.format("Condition not approved!"));
